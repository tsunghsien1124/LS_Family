...
for η_i in 1:parameters.η_size, z_i in 1:parameters.z_size
      for a_i in 1:(parameters.a_ind_zero_dist-1)
            debt_to_wage_income_S[a_i,z_i,η_i] = abs(parameters.a_grid_dist[a_i])/(parameters.z_grid[z_i]*parameters.η_grid[η_i]*(variables.n_S[a_i,z_i,η_i]^parameters.θ))
            μ_in_debt_S[a_i,z_i,η_i] = μ_S[a_i,z_i,η_i]
      end
end
...
for η_i in 1:parameters.η_size
    welfare_S += parameters.Γ_η[η_i]*V_S[parameters.a_ind_zero,2,η_i]
end
