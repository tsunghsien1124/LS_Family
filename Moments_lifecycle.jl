...
for η_i in 1:parameters.η_size, z_i in 1:parameters.z_size
    global welfare_S_women += parameters.Γ_η[η_i]*parameters.Γ_z_initial[z_i]*W_S_women[parameters.a_ind_zero,z_i,η_i,1,1]
end
...
for η_i in 1:parameters.η_size, z_i in 1:parameters.z_size
    global welfare_S_men += parameters.Γ_η[η_i]*parameters.Γ_z_initial[z_i]*W_S_men[parameters.a_ind_zero,z_i,η_i,1,1]
end
...
for η_1_i in 1:parameters.η_size, η_2_i in 1:parameters.η_size, z_1_i in 1:parameters.z_size, z_2_i in 1:parameters.z_size
    global welfare_C += parameters.Γ_η[η_1_i]*parameters.Γ_η[η_2_i]*parameters.Γ_z_initial[z_1_i]*parameters.Γ_z_initial[z_2_i]*W_C[parameters.a_ind_zero,z_1_i,z_2_i,η_1_i,η_2_i,1,1,1]
end
