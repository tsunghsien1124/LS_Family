...
# Unconditional
# Singles
ave_S_n = sum(parameters.n_grid[n_S_i].*μ_S)
# Couples
ave_C_n = sum(parameters.n_grid[n_C_1_i].*μ_C+parameters.n_grid[n_C_2_i].*μ_C)
...
for η_i in 1:parameters.η_size
    for z_i in 1:parameters.z_size, a_i in 1:parameters.a_size, a_p_i in 1:parameters.a_size

        global num_total_S += q_S[a_p_i,z_i]*(a_S_i[a_i,z_i,η_i] == a_p_i)*μ_S[a_i,z_i,η_i]
        global den_total_S += (a_S_i[a_i,z_i,η_i] == a_p_i)*μ_S[a_i,z_i,η_i]

        if a_p_i < parameters.a_ind_zero
            global num_S += q_S[a_p_i,z_i]*(a_S_i[a_i,z_i,η_i] == a_p_i)*μ_S[a_i,z_i,η_i]
            global den_S += (a_S_i[a_i,z_i,η_i] == a_p_i)*μ_S[a_i,z_i,η_i]
        end
    end
end
...
for η_2_i in 1:parameters.η_size
    for η_1_i in 1:parameters.η_size, z_2_i in 1:parameters.z_size, z_1_i in 1:parameters.z_size, a_i in 1:parameters.a_size, a_p_i in 1:parameters.a_size

        global num_total_C += q_C[a_p_i,z_1_i,z_2_i]*(a_C_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i] == a_p_i)*μ_C[a_i,z_1_i,z_2_i,η_1_i,η_2_i]
        global den_total_C += (a_C_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i] == a_p_i)*μ_C[a_i,z_1_i,z_2_i,η_1_i,η_2_i]

        if a_p_i < parameters.a_ind_zero
            global num_C += q_C[a_p_i,z_1_i,z_2_i]*(a_C_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i] == a_p_i)*μ_C[a_i,z_1_i,z_2_i,η_1_i,η_2_i]
            global den_C += (a_C_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i] == a_p_i)*μ_C[a_i,z_1_i,z_2_i,η_1_i,η_2_i]
        end
    end
end
