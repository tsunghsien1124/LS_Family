...
function parameters_function(;
    ...
    z_grid=z_grid, z_size=z_size, Γ_z=Γ_z, η_grid=η_grid, η_size=η_size, Γ_η=Γ_η, κ_grid=κ_grid, κ_size = κ_size, Γ_κ = Γ_κ, BM_indices = BM_indices, n_grid=n_grid, n_size = n_size, d_size=d_size, ζ=ζ, L_ζ=L_ζ)
end
...
function value_function_singles!(
    ...
    Threads.@threads for i in CartesianIndices((1:z_size,1:η_size))
        ...
        for a_i in 1:a_size
            ...
            @inbounds v_S_D_max = maximum(variables.v_S_D[:,a_i,z_i,η_i,κ_i])
            if v_S_D_max == -Inf
                @inbounds variables.W_S_D[a_i,z_i,η_i,κ_i] = v_S_D_max
                @inbounds variables.σ_S_D[:,a_i,z_i,η_i,κ_i] .= 0.0
            else
                @inbounds v_S_D_diff = variables.v_S_D[:,a_i,z_i,η_i,κ_i] .- v_S_D_max
            ...
            @inbounds v_S_R_max = maximum(variables.v_S_R[:,:,a_i,z_i,η_i,κ_i])
            if v_S_R_max == -Inf
                ...
                @inbounds v_S_R_diff = variables.v_S_R[:,:,a_i,z_i,η_i,κ_i] .- v_S_R_max
...
function value_function_couples!(
    ...
    @unpack  a_size, z_size, η_size, κ_size, a_grid, z_grid, η_grid, κ_grid, T, θ, β, ρ, Γ_z, Γ_η, Γ_κ, ϕ, a_ind_zero, λ, BM_indices, α, n_grid, n_size, ζ, L_ζ = parameters

    W_expect_mat = reshape(W_C_p,a_size,:)*transpose(kron(reshape(parameters.Γ_κ,1,:),kron(reshape(parameters.Γ_κ,1,:),kron(reshape(parameters.Γ_η,1,:),kron(reshape(parameters.Γ_η,1,:),kron(parameters.Γ_z,parameters.Γ_z))))))
    ...
    Threads.@threads for i in CartesianIndices((1:z_size,1:η_size))
        ...
        for a_i in 1:a_size, n_2_i in 1:n_size, n_1_i in 1:n_size
            ...
            if (a<0)
                ...
                if c <= 0.0
                    ...
                    @inbounds variables.v_C_D[n_1_i, n_2_i, a_i, z_1_i, z_2_i, η_1_i, η_2_i, κ_1_i, κ_2_i] = λ*utility_function(c/2,l_1) + (1-λ)*utility_function(c/2,l_2)+ β*ρ*W_expect_mat[a_ind_zero,z_i]
                end
            end
        end
                ...
                if ub != 0
                    ...
                    for a_p_i in lb:ub
                        ...
                        if c <= 0.0
                            ...
                            @inbounds variables.v_C_R[a_p_i, n_1_i, n_2_i, a_i, z_1_i, z_2_i, η_1_i, η_2_i, κ_1_i, κ_2_i] = λ*utility_function(c/2,l_1) + (1-λ)*utility_function(c/2,l_2)+ β*ρ*W_expect_mat[a_p_i,z_i]
                        end
                    end
                    ...
                    if all(variables.v_C_R[:,n_1_i,n_2_i, a_i, z_1_i, z_2_i, η_1_i, η_2_i, κ_1_i, κ_2_i] .== -Inf)
                        ...
                        @inbounds U_star = maximum(variables.v_C_R[:,n_1_i,n_2_i, a_i, z_1_i, z_2_i, η_1_i, η_2_i, κ_1_i, κ_2_i])

                        # Get new bounds (in terms of asset grid index!)
                        @inbounds lb_new = findfirst(variables.v_C_R[:,n_1_i,n_2_i, a_i, z_1_i, z_2_i, η_1_i, η_2_i, κ_1_i, κ_2_i] .- U_star .>= L_ζ)
                        @inbounds ub_new = findlast(variables.v_C_R[:,n_1_i,n_2_i, a_i, z_1_i, z_2_i, η_1_i, η_2_i, κ_1_i, κ_2_i] .- U_star .>= L_ζ)
        ...
        for a_i in 1:a_size
            ...
            @inbounds v_C_D_max = maximum(variables.v_C_D[:,:, a_i, z_1_i, z_2_i, η_1_i, η_2_i, κ_1_i, κ_2_i])
            if v_C_D_max == -Inf
                ...
                @inbounds v_C_D_diff = variables.v_C_D[:,:,a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i] .- v_C_D_max
            ...
            @inbounds v_C_R_max = maximum(variables.v_C_R[:,:,:,a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i])
            if v_C_R_max == -Inf
                ...
                @inbounds v_C_R_diff = variables.v_C_R[:,:,:,a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i] .- v_C_R_max
...
function pricing_function!(
    ...
    Threads.@threads for a_p_i in 1:(a_ind_zero-1)
        for z_i in 1:z_size
            ...
            for κ_p_i in 1:κ_size, η_p_i in 1:η_size, z_p_i in 1:z_size
                @inbounds P_expect += Γ_z[z_i,z_p_i]*Γ_η[η_p_i]*Γ_κ[κ_p_i]*(1.0-sum(variables.σ_S[1,:,a_p_i,z_p_i,η_p_i,κ_p_i]))
            end
    ...
    Threads.@threads for a_p_i in 1:(a_ind_zero-1)
        for z_2_i in 1:z_size, z_1_i in 1:z_size
            ...
            for κ_2_p_i in 1:κ_size, κ_1_p_i in 1:κ_size, η_2_p_i in 1:η_size, η_1_p_i in 1:η_size, z_2_p_i in 1:z_size, z_1_p_i in 1:z_size
                @inbounds P_expect += Γ_z[z_1_i,z_1_p_i]*Γ_z[z_2_i,z_2_p_i]*Γ_η[η_1_p_i]*Γ_η[η_2_p_i]*Γ_κ[κ_1_p_i]*Γ_κ[κ_2_p_i]*(1.0-sum(variables.σ_C[1,:,:,a_p_i,z_1_p_i,z_2_p_i,η_1_p_i,η_2_p_i,κ_1_p_i,κ_2_p_i]))
            end
