...
@showprogress 1 "Computing..." for period_i in 1:(num_periods-1)
    ...
    Threads.@threads for hh_i in 1:num_S
        if period_i == 1 || shock_S_ρ[hh_i,period_i] == 2
            ...
            # Compute choices
            # a
            panel_S_a[hh_i,period_i+1] = a_S_i[a_i,z_i,η_i]
            # default decision
            panel_S_d[hh_i,period_i] = d_S_i[a_i,z_i,η_i]
            # Labor Supply
            panel_S_n[hh_i,period_i] = n_S_i[a_i,z_i,η_i]
    ...
    Threads.@threads for hh_i in 1:num_C
        if period_i == 1 || shock_C_ρ[hh_i,period_i] == 2
            ...
            # Compute choices
            # a
            panel_C_a[hh_i,period_i+1] = a_C_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i]
            # default decision
            panel_C_d[hh_i,period_i] = d_C_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i]
            # Labor Supply
            panel_C_1_n[hh_i,period_i] = n_C_1_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i]
            panel_C_2_n[hh_i,period_i] = n_C_2_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i]
