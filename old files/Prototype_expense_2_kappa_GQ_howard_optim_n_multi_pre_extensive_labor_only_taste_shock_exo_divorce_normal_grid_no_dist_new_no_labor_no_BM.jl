...
function parameters_function(;
    ...
    z_grid=z_grid, z_size=z_size, Γ_z=Γ_z, η_grid=η_grid, η_size=η_size, Γ_η=Γ_η, BM_indices = BM_indices, d_size=d_size, ζ=ζ, L_ζ=L_ζ, ψ=ψ, κ = κ)
end
...
function value_function_singles!(
    ...
    #     refund += variables.μ_S[a_i,z_i,η_i,κ_i]*ρ*variables.σ_S[1,a_i,z_i,η_i,κ_i]*(z_grid[z_i]*η_grid[η_i]*(1.0^θ))*ϕ
    # end
        ...
        for κ_i in 1:κ_size
            ...
            for a_i in 1:a_size
                ...
                for a_p_i in 1:a_size
                    ...
                    # @inbounds c = z*η*(1.0^(θ))+a-variables.q_S[a_p_i,z_i]*a_p-κ+refund
...
function pricing_function!(
    ...
    Threads.@threads for a_p_i in 1:(a_ind_zero-1)
        for z_i in 1:z_size
            ...
            for κ_p_i in 1:κ_size, η_p_i in 1:η_size, z_p_i in 1:z_size
                @inbounds @views P_expect += Γ_z[z_i,z_p_i]*Γ_η[η_p_i]*Γ_κ[κ_p_i]*(1.0-variables.σ_S[1,a_p_i,z_p_i,η_p_i,κ_p_i])
            end
