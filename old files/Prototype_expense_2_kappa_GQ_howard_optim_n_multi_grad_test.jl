# Prototype model, Test file where θ is set to 1 in order to pin down n_2 using n_1 in couples' problem, WiP
...
function Util_R_C_optim_function(
    ...
    n_2 = T+((1-λ)/λ)*z_1*η_1/(z_2*η_2)*(n[1]-T)

    @inbounds l_1 = T - n[1]
    # @inbounds l_2 = T - n[2]
    l_2 = T - n_2
    # @inbounds c = z_1*η_1*(n[1]^θ)+z_2*η_2*(n[2]^θ)+a-q_C*a_p-κ_1-κ_2
    @inbounds c = z_1*η_1*(n[1]^θ)+z_2*η_2*(n_2^θ)+a-q_C*a_p-κ_1-κ_2
