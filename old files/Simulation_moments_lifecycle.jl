...
fraction_div_loan_users_sim_ave = zeros(2)
for gender in 1:2
    fraction_div_loan_users_sim_ave[gender] = sum(fraction_div_loan_users_sim[2:end,gender])/(parameters.lifespan-2)
end
...
for age in 1:(parameters.lifespan-1), gender in 1:2
    for hh_i in 1:num_S, monte_i in 1:monte_sim
        if (panel_S_a[hh_i,age+1,gender,monte_i] .< parameters.a_ind_zero)
            ...
            if gender == 1
                income_S_sim[age,gender] += parameters.z_grid[shock_S_z[hh_i,age,gender,monte_i],gender]*parameters.η_grid[shock_S_η[hh_i,age,gender,monte_i]]*parameters.h_grid[age]*parameters.n_grid_women[panel_S_n[hh_i,age,gender,monte_i]]
            else
                income_S_sim[age,gender] += parameters.z_grid[shock_S_z[hh_i,age,gender,monte_i],gender]*parameters.η_grid[shock_S_η[hh_i,age,gender,monte_i]]*parameters.h_grid[age]*parameters.n_grid_men[panel_S_n[hh_i,age,gender,monte_i]]
            end
        end
    end
end
...
for gender in 1:2
    ...
    temp_den = 0.0
    for age in 1:(parameters.lifespan-1)
        if (isnan(debt_to_inc_S_sim[age,gender]) == false)
...
temp_den = 0.0
for gender in 1:2
    if (isnan(debt_to_inc_S_sim_ave_gender[gender]) == false)
...
for age in 1:(parameters.lifespan-1), gender in 1:2
    for hh_i in 1:num_C, monte_i in 1:monte_sim
        if (panel_C_a[hh_i,age+1,gender,monte_i] .< parameters.a_ind_zero) && (shock_C_div[hh_i,age,monte_i] == 1)
            ...
            if gender == 1
                income_div_sim[age,gender] += parameters.z_grid[shock_C_z[hh_i,age,gender,monte_i],gender]*parameters.η_grid[shock_C_η[hh_i,age,gender,monte_i]]*parameters.h_grid[age]*parameters.n_grid_women[panel_C_n[hh_i,age,gender,monte_i]]
            else
                income_div_sim[age,gender] += parameters.z_grid[shock_C_z[hh_i,age,gender,monte_i],gender]*parameters.η_grid[shock_C_η[hh_i,age,gender,monte_i]]*parameters.h_grid[age]*parameters.n_grid_men[panel_C_n[hh_i,age,gender,monte_i]]
            end
        end
    end
end
...
for gender in 1:2
    debt_to_inc_div_sim_ave_gender[gender] = sum(debt_to_inc_div_sim[2:end,gender])/(parameters.lifespan-2)
end

debt_to_inc_div_sim_ave = sum(debt_to_inc_div_sim_ave_gender)/2
...
for age in 1:(parameters.lifespan-1)
    for hh_i in 1:num_C, monte_i in 1:monte_sim
        if (panel_C_a[hh_i,age+1,1,monte_i] .< parameters.a_ind_zero) && (shock_C_div[hh_i,age+1,monte_i] == 2)
            ...
            income_C_sim[age] += parameters.z_grid[shock_C_z[hh_i,age,1,monte_i],1]*parameters.η_grid[shock_C_η[hh_i,age,1,monte_i]]*parameters.h_grid[age]*parameters.n_grid_women[panel_C_n[hh_i,age,1,monte_i]] + parameters.z_grid[shock_C_z[hh_i,age,2,monte_i],2]*parameters.η_grid[shock_C_η[hh_i,age,2,monte_i]]*parameters.h_grid[age]*parameters.n_grid_men[panel_C_n[hh_i,age,2,monte_i]]
        end
    end
end
...
for age in 1:(parameters.lifespan-1)
    if (isnan(debt_to_inc_C_sim[age]) == false)
...
ave_bank_rate_div_sim_ave = zeros(2)
for gender in 1:2
...
for age in 1:parameters.lifespan, gender in 1:2
    if gender == 1
        labor_S_sim[age,gender] = sum(parameters.n_grid_women[panel_S_n[:,age,gender,:]])/(num_S*monte_sim)
    else
        labor_S_sim[age,gender] = sum(parameters.n_grid_men[panel_S_n[:,age,gender,:]])/(num_S*monte_sim)
    end
end
...
for age in 1:parameters.lifespan, gender in 1:2
    ...
    for hh_i in 1:num_C, monte_i in 1:monte_sim
        if shock_C_div[hh_i,age,monte_i] == 1
            if gender == 1
                labor_div_sim_num += parameters.n_grid_women[panel_C_n[hh_i,age,1,monte_i]]
                labor_div_sim_den += 1.0
            else
                labor_div_sim_num += parameters.n_grid_men[panel_C_n[hh_i,age,2,monte_i]]
                labor_div_sim_den += 1.0
            end
        end
    end
...
labor_div_sim_ave = zeros(2)
for gender in 1:2
    labor_div_sim_ave[gender] = sum(labor_div_sim[2:end,gender])/(parameters.lifespan-1)
end
...
for age in 1:parameters.lifespan, gender in 1:2
    ...
    for hh_i in 1:num_C, monte_i in 1:monte_sim
        if shock_C_div[hh_i,age,monte_i] == 2
            if gender == 1
                labor_C_sim_num += parameters.n_grid_women[panel_C_n[hh_i,age,1,monte_i]]
                labor_C_sim_den += 1.0
            else
                labor_C_sim_num += parameters.n_grid_men[panel_C_n[hh_i,age,2,monte_i]]
                labor_C_sim_den += 1.0
            end
        end
    end
