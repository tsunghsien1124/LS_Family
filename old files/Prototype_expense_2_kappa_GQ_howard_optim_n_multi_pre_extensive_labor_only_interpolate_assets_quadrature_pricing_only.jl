...
function parameters_function(;
    ...
    # return the outcome
    return (β=β, λ=λ, r=r, ρ=ρ, T=T, α=α, γ_c=γ_c, γ_l=γ_l, ϕ=ϕ, θ=θ, ν=ν,
...
function pricing_function!(
    ...
    Threads.@threads for a_p_i in 1:(a_ind_zero-1)
        ...
        for z_i in 1:z_size
            ...
            (R_expect,err) = hcubature(g::Function, x_min, x_max; abstol=1e-6, maxevals=0)
