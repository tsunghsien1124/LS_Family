...
vline!([-0.10714285795208994], lc=:black)

vline!([-0.1607143938274038], lc=:black)
...
#========================#
# Risky borrowing limit  #
#========================#
# Singles
plot_borr_lim_S_e = plot(box = :on, size = [800, 500],
                xtickfont = font(12, "Computer Modern", :black),
                ytickfont = font(12, "Computer Modern", :black),
                legendfont = font(12, "Computer Modern", :black),
                guidefont = font(14, "Computer Modern", :black),
...
plot_borr_lim_S_e = plot!(parameters.a_grid[1:parameters.a_ind_zero],abs.(q_S[1:parameters.a_ind_zero,1].*parameters.a_grid[1:parameters.a_ind_zero]),legend=:topleft,label="\$ z=$(round(parameters.z_grid[1],digits=2)) \$", lw = 3, lc= :blue, xlabel = L"a'", title=L"\textrm{Risky\ Borrowing\ Limit\ for\ Singles\ } q_S(a',z) \cdot a'")
plot_borr_lim_S_e = plot!(parameters.a_grid[1:parameters.a_ind_zero],abs.(q_S[1:parameters.a_ind_zero,2].*parameters.a_grid[1:parameters.a_ind_zero]), label="\$ z=$(round(parameters.z_grid[2],digits=2)) \$",lw = 3, lc = :red)
plot_borr_lim_S_e = plot!(parameters.a_grid[1:parameters.a_ind_zero],abs.(q_S[1:parameters.a_ind_zero,3].*parameters.a_grid[1:parameters.a_ind_zero]), label="\$ z=$(round(parameters.z_grid[3],digits=2)) \$",lw = 3, lc = :green)
# plot_q_S_e = plot!(parameters.a_grid[1:parameters.a_ind_zero],q_S[1:parameters.a_ind_zero,4], label="\$ z=$(round(parameters.z_grid[4],digits=2)) \$",lw = 3, lc = :purple)
# plot_q_S_e = plot!(parameters.a_grid[1:parameters.a_ind_zero],q_S[1:parameters.a_ind_zero,5], label="\$ z=$(round(parameters.z_grid[5],digits=2)) \$",lw = 3, lc = :black)

vline!([-0.1607143938274038], lc=:black)

savefig(plot_borr_lim_S_e, string(path,"plot_borr_lim_S_e.pdf"))
...
plot_n_S = plot!(parameters.a_grid,n_S[:,1,η_ind,κ_ind],legend=:bottomleft,label="\$ z=$(round(parameters.z_grid[1],digits=2)) \$", lw = 3, lc= :blue, xlabel = L"a", title="\$ \\textrm{Labor supply choice for Singles } n_S(a,z,\\eta=$(round(parameters.η_grid[η_ind],digits=2)),\\kappa=$(round(parameters.κ_grid[κ_ind],digits=2))) \$")
...
plot_n_S = plot!(parameters.a_grid,n_S[:,2,η_ind,κ_ind], label="\$ z=$(round(parameters.z_grid[2],digits=2)) \$",lw = 3, lc = :green)
...
plot_n_S = plot!(parameters.a_grid,n_S[:,3,η_ind,κ_ind], label="\$ z=$(round(parameters.z_grid[3],digits=2)) \$",lw = 3, lc = :black)
...
plot_a_S = plot!(parameters.a_grid,a_S[:,1,η_ind,κ_ind],legend=:topleft,label="\$ z=$(round(parameters.z_grid[1],digits=2)) \$", lw = 3, lc= :blue, xlabel = L"a", title="\$ \\textrm{Asset\\ choice\\ for\\ Singles\\ } a_S(a,z,\\eta=$(round(parameters.η_grid[η_ind],digits=2)),\\kappa=$(round(parameters.κ_grid[κ_ind],digits=2))) \$")
plot_a_S = plot!(parameters.a_grid,a_S[:,2,η_ind,κ_ind], label="\$ z=$(round(parameters.z_grid[2],digits=2)) \$",lw = 3, lc = :green)
plot_a_S = plot!(parameters.a_grid,a_S[:,3,η_ind,κ_ind], label="\$ z=$(round(parameters.z_grid[3],digits=2)) \$",lw = 3, lc = :black)

vline!([-0.1607143938274038], lc=:black)
hline!([-0.1607143938274038], lc=:black)
