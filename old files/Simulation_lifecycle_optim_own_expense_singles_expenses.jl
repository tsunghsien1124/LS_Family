...
# set seed
# Random.seed!(95969) # Original seed
Random.seed!(5623591) # Test seed
        ...
        for hh_i in 1:num_C
            if (age == 1) || (shock_C_div[hh_i,age,monte_i] == 2)
                ...
                if d_i == 2 # Default
                    ...
                    # x = parameters.z_grid[z_1_i,1]*parameters.h_grid[age]*parameters.n_grid[n_1_i]+parameters.z_grid[z_2_i,2]*parameters.h_grid[age]*parameters.n_grid[n_2_i]+parameters.a_grid[a_i]-q_C[a_p_i,z_1_i,z_2_i,age]*parameters.a_grid[a_p_i]-parameters.κ_grid[age,2,κ_1_i]- parameters.κ_grid[age,2,κ_2_i] # 2 is for singles, couples have singles expenses
                    x = parameters.z_grid[z_1_i,1]*parameters.h_grid[age]*parameters.n_grid[n_1_i]+parameters.z_grid[z_2_i,2]*parameters.h_grid[age]*parameters.n_grid[n_2_i]+parameters.a_grid[a_i]-q_C[a_p_i,z_1_i,z_2_i,age]*parameters.a_grid[a_p_i]-parameters.κ_grid[age,1,κ_1_i]- parameters.κ_grid[age,1,κ_1_i] # 1 is for couples, perfectly correlated expense shocks
                    panel_C_c[hh_i,age,:,monte_i] .= x/(2^(1/parameters.ρ_s))
                end
