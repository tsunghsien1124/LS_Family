...
function parameters_function(;
    ...
    n_grid=n_grid, n_size=n_size, z_grid=z_grid, z_size=z_size, Γ_z=Γ_z, η_grid=η_grid, η_size=η_size, Γ_η=Γ_η, κ_grid=κ_grid, κ_size = κ_size, Γ_κ = Γ_κ, BM_indices = BM_indices)
end
...
mutable struct MutableVariables
    ...
    n_S_i::Array{Int64,4}
    n_C_1_i::Array{Int64,7}
    n_C_2_i::Array{Int64,7}
    # l_S::Array{Float64,3}
...
function variables_function(
    ...
    n_C_1_i = zeros(Int64,a_size, z_size, z_size, η_size, η_size, κ_size, κ_size)
    n_C_2_i = zeros(Int64,a_size, z_size, z_size, η_size, η_size, κ_size, κ_size)
...
function value_function_singles!(
    ...
    @unpack  a_size, z_size, η_size, n_size, κ_size, a_grid, z_grid, η_grid, n_grid, κ_grid, T, θ, β, ρ, Γ_z, Γ_η, Γ_κ, ϕ, a_ind_zero, BM_indices = parameters
    ...
    Threads.@threads for i in CartesianIndices((1:z_size,1:η_size,1:κ_size))
        # lb_new = 1
...
function howard_singles!(
    ...
    while iter <= howard_iter
        ...
        Threads.@threads for i in CartesianIndices((1:a_size,1:z_size,1:η_size,1:κ_size))
            @inbounds a_i = i[1]
            @inbounds z_i = i[2]
            @inbounds η_i = i[3]
            @inbounds κ_i = i[4]
            ...
            @inbounds a_p = a_grid[a_p_i]
            @inbounds n = n_grid[variables.n_S_i[a_i,z_i,η_i,κ_i]]
...
function value_function_couples!(
    ...
    @unpack  a_size, z_size, η_size, n_size, κ_size, a_grid, z_grid, η_grid, n_grid, κ_grid, T, θ, β, ρ, Γ_z, Γ_η, Γ_κ, ϕ, a_ind_zero, λ, BM_indices = parameters
    ...
    Threads.@threads for i in CartesianIndices((1:z_size,1:z_size,1:η_size,1:η_size,1:κ_size,1:κ_size))
        # lb_new = 1
        ...
        for BM_i in 1:a_size
            ...
            if ub != 0
                ...
                for a_p_i in lb:ub, n_1_i in 1:n_size, n_2_i in 1:n_size
                    ...
                    if v_temp > variables.V_C[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i]
                        @inbounds variables.V_C[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i] = v_temp
                        ...
                        @inbounds variables.n_C_1_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i] = n_1_i
                        @inbounds variables.n_C_2_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i] = n_2_i
                        BM_bounds[a_i,2] = a_p_i
                        BM_bounds[a_i,3] = a_p_i
                    end
                end
    ...
    Threads.@threads for i in CartesianIndices((1:z_size,1:z_size,1:η_size,1:η_size))
...
function howard_couples!(
    ...
    while iter <= howard_iter
        ...
        Threads.@threads for i in CartesianIndices((1:a_size,1:z_size,1:z_size,1:η_size,1:η_size,1:κ_size,1:κ_size))
            @inbounds a_i = i[1]
            @inbounds z_1_i = i[2]
            @inbounds z_2_i = i[3]
            @inbounds η_1_i = i[4]
            ...
            @inbounds a_p = a_grid[a_p_i]
            @inbounds n_1 = n_grid[variables.n_C_1_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i]]
            @inbounds n_2 = n_grid[variables.n_C_2_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i]]
