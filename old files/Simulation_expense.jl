...
# Expense shocks
shock_C_κ = zeros(Int, num_C, num_periods)
...
@showprogress 1 "Computing..." for period_i in 1:(num_periods-1)
    ...
    Threads.@threads for hh_i in 1:num_C
        if period_i == 1 || shock_C_ρ[hh_i,period_i] == 2
            ...
            # Compute choices
            # a
            panel_C_a[hh_i,period_i+1] = a_C_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_i]
            # default decision
            panel_C_d[hh_i,period_i] = d_C_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_i]
            # Labor Supply
            panel_C_1_n[hh_i,period_i] = n_C_1_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_i]
            panel_C_2_n[hh_i,period_i] = n_C_2_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_i]
...
shock_C_κ = shock_C_κ[:,burn_in+1:end-1]
...
# Couples
event_κ_C = zeros(num_S,period_all)
for hh_i in 1:num_S, period_i in 2:period_all
    event_κ_C[hh_i,period_i] = (shock_C_κ[hh_i,period_i] == κ_shock)
end

# event_S = event_S[:,(event_window+1):(period_all-event_window)]

num_events_κ_C =  Int(sum(event_κ_C[:,3:(period_all-event_window)]))

event_κ_C_default = zeros(num_events_κ_C,event_window+3)

counter = 0

for hh_i in 1:num_S, period_i in 2:period_all
    if (event_κ_C[hh_i,period_i] == 1) && (period_i > 2)  && (period_i <= period_all-event_window)
        counter += 1
        event_κ_C_default[counter,:] = d_grid[panel_C_d[hh_i,(period_i-2):(period_i+event_window)]]
    end
end

event_κ_C_default_ave = sum(event_κ_C_default,dims=1)./counter

event_κ_C_default_ave_norm = event_κ_C_default_ave ./ event_κ_C_default_ave[2]
