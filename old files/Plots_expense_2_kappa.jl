...
path = "C:/Users/JanSun/Dropbox/Bankruptcy-Family/Results/29-fixed-multi-thread/"
...
#                 margin = 4mm
#                 )
# plot_a_C = plot!(parameters.a_grid,parameters.a_grid[Int.(a_C_i[:,1,1,η_ind,η_ind,κ_1_ind,κ_2_ind])],legend=:topleft,label="\$ z=$(round(parameters.z_grid[1],digits=2)) \$", lw = 3, lc= :blue, xlabel = L"a", title="\$ \\textrm{Asset choice for Couples } a_C(a,z,\\eta=$(round(parameters.η_grid[η_ind],digits=2))) \$")
