    ...
    for age in 1:parameters.lifespan
        ...
        for hh_i in 1:num_S, gender in 1:2
            ...
            if d_i == 2 # Default
                ...
                panel_S_c[hh_i,age,gender,monte_i] = parameters.z_grid[z_i,gender]*parameters.h_grid[age]*parameters.n_grid[n_i]+parameters.a_grid[a_i]-q_S[a_p_i,z_i,age,gender]*parameters.a_grid[a_p_i] - parameters.κ_grid[κ_i]
            end
        end
        ...
        for hh_i in 1:num_C
            if (age == 1) || (shock_C_div[hh_i,age,monte_i] == 2)
                ...
                if d_i == 2 # Default
                    ...
                    panel_C_n[hh_i,age,1,monte_i] = n_1_i
                    panel_C_n[hh_i,age,2,monte_i] = n_2_i
                    x = parameters.z_grid[z_1_i,1]*parameters.h_grid[age]*parameters.n_grid[n_1_i]+parameters.z_grid[z_2_i,2]*parameters.h_grid[age]*parameters.n_grid[n_2_i]+parameters.a_grid[a_i]-q_C[a_p_i,z_1_i,z_2_i,age]*parameters.a_grid[a_p_i]-parameters.κ_grid[κ_1_i]- parameters.κ_grid[κ_2_i]
                    panel_C_c[hh_i,age,:,monte_i] .= x/(2^(1/parameters.ρ_s))
                end
                ...
                if shock_C_div[hh_i,age-1,monte_i] == 2 # Married in last period
                    ...
                    for gender in 1:2
                        ...
                        if d_i == 2 # Default
                            ...
                            panel_C_c[hh_i,age,gender,monte_i] = parameters.z_grid[z_i,gender]*parameters.h_grid[age]*parameters.n_grid[n_i]+parameters.a_grid[a_i]-q_S[a_p_i,z_i,age,gender]*parameters.a_grid[a_p_i]-parameters.κ_grid[κ_i]-parameters.κ_div
                        end
                    end
                else
                    for gender in 1:2
                        ...
                        if d_i == 2 # Default
                            ...
                            panel_C_c[hh_i,age,gender,monte_i] = parameters.z_grid[z_i,gender]*parameters.h_grid[age]*parameters.n_grid[n_i]+parameters.a_grid[a_i]-q_S[a_p_i,z_i,age,gender]*parameters.a_grid[a_p_i]-parameters.κ_grid[κ_i]
                        end
                    end
                end
            end
