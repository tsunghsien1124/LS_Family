...
function parameters_function(;
    ...
    a_size_neg::Integer = 6,                   # number of  assets
...
function value_function_singles!(
    ...
    @unpack  a_size, z_size, η_size, a_grid, z_grid, η_grid, T, θ, β, ρ, Γ_z, Γ_η, ϕ, a_ind_zero, BM_indices, α, n_grid, n_size, ζ, L_ζ = parameters
        ...
        for a_i in 1:a_size, n_i in 1:n_size
            ...
            if (a<0)
                ...
                if c <= 0.0
                    ...
                    @inbounds variables.v_S_D[n_i, a_i, z_i, η_i] = utility_function(c,l) + β*ρ*W_expect_mat[a_ind_zero,z_i]
                end
            end
        end
                ...
                if ub != 0
                    ...
                    for a_p_i in lb:ub
                        ...
                        if c <= 0.0
                            ...
                            @inbounds variables.v_S_R[a_p_i,n_i, a_i, z_i, η_i] = utility_function(c,l) + β*ρ*W_expect_mat[a_p_i,z_i]
                        end
                    end
                ...
                if ub != 0
                    ...
                    for a_p_i in lb:ub
                        ...
                        if c <= 0.0
                            ...
                            @inbounds variables.v_C_R[a_p_i, n_1_i, n_2_i, a_i, z_1_i, z_2_i, η_1_i, η_2_i] = λ*utility_function(c/2,l_1) + (1-λ)*utility_function(c/2,l_2)+ β*ρ*(1-ψ)*W_expect_C_mat[a_p_i,z_i] + β*ρ*ψ*(λ*W_expect_S_mat[a_p_i_half, z_1_i] + (1-λ)*W_expect_S_mat[a_p_i_half, z_2_i])
                        end
                    end
            ...
            for η_2_p_i in 1:η_size, z_2_p_i in 1:z_size, a_p_i in 1:a_size
                ...
                for η_2_i in 1:η_size, η_1_i in 1:η_size, z_2_i in 1:z_size, z_1_i in 1:z_size, a_i in 1:a_size
                    ...
                    if a_p_i == a_ind_zero
                        ...
                        @inbounds μ_temp_newborn += (1-ρ)*Γ_η[η_p_i]*Γ_η[η_2_p_i]*(z_p_i == 3)*(z_2_p_i == 3)*μ_C_p[a_i,z_1_i,z_2_i,η_1_i,η_2_i]
                    end
                end
...
stationary_distribution!(variables, parameters; tol = 1E-5, iter_max = 1000)
