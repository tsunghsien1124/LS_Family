...
function parameters_function(;
    ...
    # ϕ::Real = 0.319,                           # Wage garnishment, taken from Livshits et al. (2010), needs to be internally calibrated
    # ϕ::Real = 0.41,
    ϕ::Real = 0.95,
    ...
    # ψ::Real = 0.0373,                              # exogenously calibrated from Livshits et al. (2007)
...
# 0.00024362075390	0.00752487973592	0.05603155653834	0.23546001015495	0.70073993281691]
    ...
    # Subset into 95th and 98th percentile, base is no shock
    κ_grid = zeros(lifespan, 2, 3)
...
# cd("C:/Users/jsun/Dropbox/Bankruptcy-Family/Results/Current/Calibration-small-grid")
