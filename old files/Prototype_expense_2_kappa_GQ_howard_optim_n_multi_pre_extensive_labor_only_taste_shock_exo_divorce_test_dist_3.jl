        ...
        Threads.@threads for i in CartesianIndices((1:z_size,1:η_size))
            ...
            for κ_p_i in 1:κ_size, a_p_i in 1:a_size
                ...
                for κ_i in 1:κ_size, η_i in 1:η_size, z_i in 1:z_size, a_i in 1:a_size
                    ...
                    if a_p_i == a_ind_zero
                        @inbounds @views variables.μ_S[a_p_i,z_p_i,η_p_i,κ_p_i] += ρ*Γ_z[z_i,z_p_i]*Γ_η[η_p_i]*Γ_κ[κ_p_i]*sum(variables.σ_S[1+a_p_i,:,a_i,z_i,η_i,κ_i])*μ_S_p[a_i,z_i,η_i,κ_i] + ρ*Γ_z[z_i,z_p_i]*Γ_η[η_p_i]*Γ_κ[κ_p_i]*sum(variables.σ_S[1,:,a_i,z_i,η_i,κ_i])*μ_S_p[a_i,z_i,η_i,κ_i] + (1-ρ)*Γ_η[η_p_i]*(z_p_i == 3)*(κ_p_i == 1)*μ_S_p[a_i,z_i,η_i,κ_i]
                    else
                        @inbounds @views variables.μ_S[a_p_i,z_p_i,η_p_i,κ_p_i] += ρ*Γ_z[z_i,z_p_i]*Γ_η[η_p_i]*Γ_κ[κ_p_i]*sum(variables.σ_S[1+a_p_i,:,a_i,z_i,η_i,κ_i])*μ_S_p[a_i,z_i,η_i,κ_i]
                    end
                end
            end
            ...
            for κ_2_p_i in 1:κ_size, κ_1_p_i in 1:κ_size, η_2_p_i in 1:η_size, z_2_p_i in 1:z_size, a_p_i in 1:a_size
                ...
                for κ_2_i in 1:κ_size, κ_1_i in 1:κ_size, η_2_i in 1:η_size, η_1_i in 1:η_size, z_2_i in 1:z_size, z_1_i in 1:z_size, a_i in 1:a_size
                    ...
                    if a_p_i == a_ind_zero
                        @inbounds @views variables.μ_C[a_p_i,z_p_i,z_2_p_i,η_p_i,η_2_p_i,κ_1_p_i,κ_2_p_i] += ρ*Γ_z[z_1_i,z_p_i]*Γ_z[z_2_i,z_2_p_i]*Γ_η[η_p_i]*Γ_η[η_2_p_i]*Γ_κ[κ_1_p_i]*Γ_κ[κ_2_p_i]*sum(variables.σ_C[1+a_p_i,:,:,a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i])*μ_C_p[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i] + ρ*Γ_z[z_1_i,z_p_i]*Γ_z[z_2_i,z_2_p_i]*Γ_η[η_p_i]*Γ_η[η_2_p_i]*Γ_κ[κ_1_p_i]*Γ_κ[κ_2_p_i]*sum(variables.σ_C[1,:,:,a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i])*μ_C_p[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i] + (1-ρ)*Γ_η[η_p_i]*Γ_η[η_2_p_i]*(z_p_i == 3)*(z_2_p_i == 3)*(κ_1_p_i == 1)*(κ_2_p_i == 1)*μ_C_p[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i]
                    else
                        @inbounds @views variables.μ_C[a_p_i,z_p_i,z_2_p_i,η_p_i,η_2_p_i,κ_1_p_i,κ_2_p_i] += ρ*Γ_z[z_1_i,z_p_i]*Γ_z[z_2_i,z_2_p_i]*Γ_η[η_p_i]*Γ_η[η_2_p_i]*Γ_κ[κ_1_p_i]*Γ_κ[κ_2_p_i]*sum(variables.σ_C[1+a_p_i,:,:,a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i])*μ_C_p[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_1_i,κ_2_i]
                    end
                end
            end
        end
