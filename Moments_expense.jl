...
for κ_i in 1:parameters.κ_size
    for η_i in 1:parameters.η_size, z_i in 1:parameters.z_size, a_i in 1:parameters.a_size, a_p_i in 1:parameters.a_size
        ...
        global num_total_S += q_S[a_p_i,z_i]*(a_S_i[a_i,z_i,η_i,κ_i] == a_p_i)*μ_S[a_i,z_i,η_i,κ_i]
        global den_total_S += (a_S_i[a_i,z_i,η_i,κ_i] == a_p_i)*μ_S[a_i,z_i,η_i,κ_i]

        if a_p_i < parameters.a_ind_zero
            global num_S += q_S[a_p_i,z_i]*(a_S_i[a_i,z_i,η_i,κ_i] == a_p_i)*μ_S[a_i,z_i,η_i,κ_i]
            global den_S += (a_S_i[a_i,z_i,η_i,κ_i] == a_p_i)*μ_S[a_i,z_i,η_i,κ_i]
        end
    end
end
...
for κ_i in 1:parameters.κ_size
    for η_2_i in 1:parameters.η_size, η_1_i in 1:parameters.η_size, z_2_i in 1:parameters.z_size, z_1_i in 1:parameters.z_size, a_i in 1:parameters.a_size, a_p_i in 1:parameters.a_size
        ...
        global num_total_C += q_C[a_p_i,z_1_i,z_2_i]*(a_C_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_i] == a_p_i)*μ_C[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_i]
        global den_total_C += (a_C_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_i] == a_p_i)*μ_C[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_i]

        if a_p_i < parameters.a_ind_zero
            global num_C += q_C[a_p_i,z_1_i,z_2_i]*(a_C_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_i] == a_p_i)*μ_C[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_i]
            global den_C += (a_C_i[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_i] == a_p_i)*μ_C[a_i,z_1_i,z_2_i,η_1_i,η_2_i,κ_i]
        end
    end
end
...
for η_1_i in 1:parameters.η_size, η_2_i in 1:parameters.η_size
    global welfare_C += parameters.Γ_η[η_1_i]*parameters.Γ_η[η_2_i]*V_C[parameters.a_ind_zero,3,3,η_1_i,η_2_i,1]
end

welfare_S_fix = V_S[parameters.a_ind_zero,3,2,1]

welfare_C_fix = V_C[parameters.a_ind_zero,3,3,2,2,1]
