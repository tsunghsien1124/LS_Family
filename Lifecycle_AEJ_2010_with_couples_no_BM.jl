...
0.00024362075390	0.00752487973592	0.05603155653834	0.23546001015495	0.70073993281691]
    ...
    z_grid=z_grid, z_size=z_size, Γ_z=Γ_z, Γ_z_initial=Γ_z_initial, η_grid=η_grid, η_size=η_size, Γ_η=Γ_η, d_size=d_size, ζ=ζ, L_ζ=L_ζ, ψ=ψ, μ_asset_newborns=μ_asset_newborns, lifespan = lifespan, h_grid=h_grid, es_grid=es_grid, κ_div=κ_div)
end
...
function value_function_couples!(
    ...
    @unpack  a_size, z_size, η_size, κ_size, a_grid, z_grid, η_grid, κ_grid, T, θ, β, Γ_z, Γ_η, Γ_κ, ϕ, a_ind_zero, λ, α, ζ, L_ζ, ψ, lifespan, h_grid, es_grid = parameters
        ...
        Threads.@threads for a_p_i in 1:(a_ind_zero-1)
            ...
            for z_2_i in 1:z_size, z_1_i in 1:z_size
                ...
                for κ_1_p_i in 1:κ_size, η_1_p_i in 1:η_size, z_1_p_i in 1:z_size
                    recovery = ((z_grid[z_1_p_i]*η_grid[η_1_p_i]*h_grid[age+1])*parameters.ϕ)/(abs(a_grid[a_p_i_half_1])+κ_grid[κ_1_p_i]+κ_div)
                ...
                for κ_2_p_i in 1:κ_size, η_2_p_i in 1:η_size, z_2_p_i in 1:z_size
                    recovery = ((z_grid[z_2_p_i]*η_grid[η_2_p_i]*h_grid[age+1])*parameters.ϕ)/(abs(a_grid[a_p_i_half_2])+κ_grid[κ_2_p_i]+κ_div)
